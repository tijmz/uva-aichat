# Introduction
Beaver is a Zotero plugin that adds LLM functionality to your library of scientific articles. For more information, see (beaver.ai)[beaver.ai](https://www.beaverapp.ai/]. Here I will document how you can connect Beaver to use UvA AI Chat. Note that streaming and tool calling are prerequisites for integrating any model with Beaver. At the time of this writing, I am not sure whether UvA Chat supports these.
